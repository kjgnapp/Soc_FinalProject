...
HD_PWD='C:/VivadoProjects/project_2/project_2.runs/design_1_apb_led_ctl_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_apb_led_ctl_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_apb_led_ctl_0_3.tcl
