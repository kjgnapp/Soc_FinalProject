...
Pong_Top2_0: component design_6_Pong_Top2_0_0
     port map (
      Dir_X => Dir_X,
      Dir_Y => Dir_Y,
      Paddle_Y_Bot(5 downto 0) => Paddle_Bot(5 downto 0),
      Paddle_Y_Top(5 downto 0) => Paddle_Top(5 downto 0),
      i_Clk => clk_wiz_0_clk_25,
      ...
      top_ball_X(5 downto 0) => ball_x(5 downto 0),
      top_ball_Y(5 downto 0) => ball_y(5 downto 0)
    );
