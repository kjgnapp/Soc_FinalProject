...
entity Pong_Top2 is
  ...
  port (
    ...
    Dir_X             : out std_logic;
    Dir_Y             : out std_logic;
    Paddle_Y_Top      : out std_logic(5 downto 0);
    Paddle_Y_Bot      : out std_logic(5 downto 0);
...
--  end process p_Reg_Syncs; 
  ...
  Paddle_Y_Bot <= std_logic_vector(w_Paddle_Y_P2_Bot);
  Paddle_Y_Top <= std_logic_vector(w_Paddle_Y_P2_Top);
