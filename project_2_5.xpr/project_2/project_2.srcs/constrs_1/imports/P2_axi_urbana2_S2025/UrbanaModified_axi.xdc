...
#set_property -dict {PACKAGE_PIN B18 IOSTANDARD LVCMOS33} [get_ports {audio_out}]
...
#set_property -dict {PACKAGE_PIN G6 IOSTANDARD LVCMOS25} [get_ports {P2_AN[0]}]  # Active LOW
#set_property -dict {PACKAGE_PIN H6 IOSTANDARD LVCMOS25} [get_ports {P2_AN[1]}]  # Active LOW
#set_property -dict {PACKAGE_PIN C3 IOSTANDARD LVCMOS25} [get_ports {P2_AN[2]}]  # Active LOW
#set_property -dict {PACKAGE_PIN B3 IOSTANDARD LVCMOS25} [get_ports {P2_AN[3]}]  # Active LOW
...
#set_property -dict {PACKAGE_PIN B5 IOSTANDARD LVCMOS25} [get_ports {P2_SEG[7]}];  # CDP Active LOW

## On-board 7-Segment display 1
#set_property -dict {PACKAGE_PIN E4 IOSTANDARD LVCMOS25} [get_ports {P1_AN[0]}]  # Active LOW
#set_property -dict {PACKAGE_PIN E3 IOSTANDARD LVCMOS25} [get_ports {P1_AN[1]}]  # Active LOW
#set_property -dict {PACKAGE_PIN F5 IOSTANDARD LVCMOS25} [get_ports {P1_AN[2]}]  # Active LOW
#set_property -dict {PACKAGE_PIN H5 IOSTANDARD LVCMOS25} [get_ports {P1_AN[3]}]  # Active LOW
...
#set_property -dict {PACKAGE_PIN J4 IOSTANDARD LVCMOS25} [get_ports {P1_SEG[7]}];  # CDP Active LOW
...
set_property SLEW FAST [get_ports audio_out]

set_property IOSTANDARD LVCMOS25 [get_ports {P2_AN[3]}]
set_property IOSTANDARD LVCMOS25 [get_ports {P2_AN[2]}]
set_property IOSTANDARD LVCMOS25 [get_ports {P2_AN[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {P2_AN[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {P1_AN[3]}]
set_property IOSTANDARD LVCMOS25 [get_ports {P1_AN[2]}]
set_property IOSTANDARD LVCMOS25 [get_ports {P1_AN[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {P1_AN[0]}]
