...
#                script (type 'myip_pong2_0.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/alexj/Downloads/Soc_FinalProject-Task2/project_2.xpr/project_2/project_2.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
