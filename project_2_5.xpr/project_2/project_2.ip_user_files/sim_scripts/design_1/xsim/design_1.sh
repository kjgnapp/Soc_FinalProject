...
#
# Script generated by Vivado on Sat Apr 26 19:49:17 -0400 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L microblaze_v11_0_14 -L microblaze_riscv_v1_0_3 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_25 -L blk_mem_gen_v8_4_9 -L axi_lite_ipif_v3_0_4 -L mdm_riscv_v1_0_3 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L lib_pkg_v1_0_4 -L lib_srl_fifo_v1_0_4 -L axi_uartlite_v2_0_37 -L xlconstant_v1_1_9 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_33 -L axi_vip_v1_1_19 -L axi_apb_bridge_v3_0_20 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_35 -L axi_timer_v2_0_35 -L util_vector_logic_v2_0_4 -L fifo_generator_v13_2_11 -L lib_fifo_v1_0_20 -L axi_datamover_v5_1_35 -L axi_sg_v4_1_19 -L axi_cdma_v4_1_33 -L axi_bram_ctrl_v4_1_11 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/bd_69f9.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
