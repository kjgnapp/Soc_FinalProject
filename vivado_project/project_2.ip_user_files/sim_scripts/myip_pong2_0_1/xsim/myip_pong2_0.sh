...
#
# Script generated by Vivado on Tue Apr 22 02:26:24 -0700 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : myip_pong2_0.sh
...
#
# Usage        : myip_pong2_0.sh
#                myip_pong2_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                myip_pong2_0.sh [-reset_run]
#                myip_pong2_0.sh [-reset_log]
#                myip_pong2_0.sh [-help]
#
...
# script info
echo -e "myip_pong2_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./myip_pong2_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L util_vector_logic_v2_0_4 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot myip_pong2_0 xil_defaultlib.myip_pong2_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim myip_pong2_0 -key {Behavioral:sim_1:Functional:myip_pong2_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb myip_pong2_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./myip_pong2_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: myip_pong2_0.sh [-help]\n\
Usage: myip_pong2_0.sh [-step]\n\
Usage: myip_pong2_0.sh [-lib_map_path]\n\
Usage: myip_pong2_0.sh [-reset_run]\n\
Usage: myip_pong2_0.sh [-reset_log]\n\
Usage: myip_pong2_0.sh [-keep_index]\n\
Usage: myip_pong2_0.sh [-noclean_files]\n\n\
