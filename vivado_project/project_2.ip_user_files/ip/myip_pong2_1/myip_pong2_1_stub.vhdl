...
-- Date        : Tue Apr 22 02:27:14 2025
-- Host        : Alex_PC running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top myip_pong2_1 -prefix
--               myip_pong2_1_ myip_pong2_0_stub.vhdl
-- Design      : myip_pong2_0
...
entity myip_pong2_1 is
  ...
  attribute CHECK_LICENSE_TYPE of myip_pong2_1 : entity is "myip_pong2_0,myip_pong2,{}";
  attribute core_generation_info : string;
  attribute core_generation_info of myip_pong2_1 : entity is "myip_pong2_0,myip_pong2,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=myip_pong2,x_ipVersion=1.0,x_ipCoreRevision=2,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,C_S00_AXI_DATA_WIDTH=32,C_S00_AXI_ADDR_WIDTH=4}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of myip_pong2_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of myip_pong2_1 : entity is "package_project";
end myip_pong2_1;

architecture stub of myip_pong2_1 is
