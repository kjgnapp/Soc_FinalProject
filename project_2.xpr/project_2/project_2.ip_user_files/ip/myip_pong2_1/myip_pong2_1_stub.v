...
//               c:/VivadoProjects/project_2/project_2.gen/sources_1/ip/myip_pong2_1/myip_pong2_1_stub.v
// Design      : myip_pong2_1
...
(* CHECK_LICENSE_TYPE = "myip_pong2_1,myip_pong2,{}" *) (* core_generation_info = "myip_pong2_1,myip_pong2,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=myip_pong2,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,C_S00_AXI_DATA_WIDTH=32,C_S00_AXI_ADDR_WIDTH=4}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* ip_definition_source = "package_project" *) (* x_core_info = "myip_pong2,Vivado 2024.2" *) 
module myip_pong2_1(s00_axi_aclk, s00_axi_aresetn, 
